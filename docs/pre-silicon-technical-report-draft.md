...
> **Superseded draft (2026-09-08):** this report describes the original
> full-cycle design (hardware revision `1e31757`, run `33839023290`, model
> `tpv-predict-1.0.1`). That design was replaced by the merged half-cycle
> design on `proposal-canary` (10 MHz normal operation, model
> `tpv-predict-2.0.0`); see `PRE_SILICON_ACTION_PLAN.md`,
> `docs/research-proposal.md` and `docs/prediction-model.md`. The v1 numbers
> below are historical evidence, not the submitted design.
