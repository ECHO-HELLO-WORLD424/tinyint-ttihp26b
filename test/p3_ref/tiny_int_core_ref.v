...
//
// P3 verification reference: a byte-for-byte frozen copy of the released
// (main-branch) tiny_int_core with only the module name changed. It is
// instantiated beside the event-scheduled core by p3_core_read_tb.v so both
// cores see identical request streams.
